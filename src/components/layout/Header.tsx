...
import NextLink from 'next/link' // これは？
import {
  Navbar,
  NavbarContent,
  NavbarItem,
    ...
    <Navbar onMenuOpenChange={setIsMenuOpen} className="mt-2">
      <NavbarContent>
        ...
        <NavbarBrand>
          ...
          <p className="font-bold text-inherit hidden sm:flex pl-4">Next.js 13 Demo App</p>
        </NavbarBrand>
      </NavbarContent>
      ...
      <NavbarContent className="hidden sm:flex gap-6" justify="center">
        ...
        <NavbarItem isActive={segment === 'about'}>
          <Link href={'/about'}>About</Link>
        </NavbarItem>
        <NavbarItem isActive={segment === 'contact'}>
          <Link href={'/contact'}>Contact</Link>
        </NavbarItem>
        <NavbarItem isActive={segment === 'tasks'}>
        ...
        <NavbarMenuItem>
          <Link
            style={{
              minWidth: '100%',
              color: 'inherit',
              fontWeight: segment === 'about' ? 'bold' : 'normal',
            }}
            href="/about"
          >
            About
        ...
        <NavbarMenuItem>
          <Link
            style={{
              minWidth: '100%',
              color: 'inherit',
              fontWeight: segment === 'contact' ? 'bold' : 'normal',
            }}
            href="/contact"
          >
            Contact
        ...
        <NavbarMenuItem>
          <Link
            style={{
              minWidth: '100%',
              color: 'inherit',
              fontWeight: segment === 'tasks' ? 'bold' : 'normal',
            }}
            href="/tasks"
          >
            Task
